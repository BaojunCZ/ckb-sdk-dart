...
void main() async {
  ...
  CkbWallet wallet = CkbWallet(ApiClient("http://192.168.2.203:8114/"), credential);

  test('get address', () {
    try {
      Unlock unlock = wallet.getCredential().getUnlockScript('res/bitcoin_unlock.rb',
...
//      String address =
//          wallet.getCredential().getAddress(wallet.getCredential().getUnlockScript('res/bitcoin_unlock.rb'));
      int balance = await wallet.getBalance("0x0da2fe99fe549e082d4ed483c2e968a89ea8d11aabf5d79e5cbf06522de6e674");
      print(balance);
    } catch (error) {
      print(jsonEncode(error));
    }
  ...
  test("get transaction", () async {
    try {
      ...
      Transaction trasaction = await wallet.generateTx(unlock, credential.getAddress(unlock), 1000);
