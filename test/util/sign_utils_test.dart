...
void main() {
  Uint8List privateKey = hex.decode("e79f3207ea4980b7fed79956d5934249ceac4751a4fae01a0f7c4a96884bc4e3");
  String message = "85a1feafb48eae47b88308f525b759d651986e5a4d80a5915cb5d28566d6c7c5";
  Uint8List messageHash = hex.decode(message);

  test("test sign message", () {
    String signature = number.bytesToHex(crypto.sign(messageHash, privateKey).getDerSignature(), include0x: true);
    expect(signature,
