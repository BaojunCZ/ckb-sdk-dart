...
class Block {
  ...
  factory Block.fromJson(Map<String, dynamic> json) => Block(
      ...
      (json['uncles'] as List)?.map((e) => e == null ? null : UncleBlock.fromJson(e as Map<String, dynamic>))?.toList(),
      (json['proposals'] as List)?.map((e) => e as String)?.toList(),
      (json['transactions'] as List)
          ?.map((e) => e == null ? null : Transaction.fromJson(e as Map<String, dynamic>))
          ?.toList());
  Map<String, dynamic> toJson() =>
      <String, dynamic>{'header': header, 'uncles': uncles, 'proposals': proposals, 'transactions': transactions};
}
